...
<TypeTable
  type={{
    description: {
      description: "Human-readable description for this block, shown in `terraform providers schema` and the Terraform Registry.",
      type: "string",
      default: '""',
    },
    descriptionKind: {
    ...
    deprecated: {
      description: "Marks the block as deprecated. Shows a warning when the block is used.",
      type: "boolean",
      default: "false",
    },
    deprecationMessage: {
      description: "Custom message shown when the block is deprecated.",
      type: "string",
      default: '""',
    },
    computed: {
      description: "The entire block is computed by the provider (advanced use).",
      type: "boolean",
      default: "false",
    },
  }}
