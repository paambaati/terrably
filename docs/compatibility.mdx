...
| `object` attribute type | ✅ | | |
| `tuple` type | ❌ | Use separate attributes or `list` + validation | [#19](https://github.com/paambaati/terrably/issues/19) |
| `dynamic` type | ❌ | Use `normalizedJson` or explicit schema | [#20](https://github.com/paambaati/terrably/issues/20) |
| Ephemeral resources | ❌ | Not prioritised yet | [#21](https://github.com/paambaati/terrably/issues/21) |
| `moved` block (cross-type) | ❌ | Not prioritised yet |
| Private provider data | ❌ | Use a computed attribute instead | [#23](https://github.com/paambaati/terrably/issues/23) |
| Resource identity schemas | ❌ | Returns empty; not prioritised yet | [#24](https://github.com/paambaati/terrably/issues/24) |
| List resources | ❌ | Terraform `list` command; not prioritised yet | [#25](https://github.com/paambaati/terrably/issues/25) |
| State stores | ❌ | Provider-managed state backends; not prioritised yet | |
| Actions | ❌ | Fairly new; not prioritised yet | [#26](https://github.com/paambaati/terrably/issues/26) |
