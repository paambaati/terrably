...
## Mode 1 — `dev_overrides` (recommended)

The simplest workflow. Terraform uses your local binary directly instead of downloading from the registry; no `terraform init` required. Read the official [Terraform documentation on dev_overrides](https://developer.hashicorp.com/terraform/cli/config/config-file#development-overrides-for-provider-developers) to learn more.
